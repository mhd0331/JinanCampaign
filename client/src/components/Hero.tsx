          ...
          <div>
            ...
            <div className="flex flex-col sm:flex-row gap-3 md:gap-4">
              <Button 
                ...
                size="lg"
                className="bg-white text-green-700 px-4 sm:px-6 md:px-8 py-3 md:py-4 text-sm sm:text-base md:text-lg font-bold hover:bg-gray-100 transition-colors shadow-lg"
              >
                공약 자세히 보기
              </Button>
              <Button 
                ...
                variant="outline"
                size="lg"
                className="border-3 border-white bg-transparent text-white px-4 sm:px-6 md:px-8 py-3 md:py-4 text-sm sm:text-base md:text-lg font-bold hover:bg-white hover:text-green-700 transition-colors shadow-lg"
              >
                AI 공약 상담하기
              </Button>
            </div>
